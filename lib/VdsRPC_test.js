...
describe("VdsRPC", () => {
    ...
    it("can convert a hex address to a p2pkh address", async () => {
        ...
        chai_1.assert.strictEqual(p2pkhAddress, "qZoV3RKeHaxKM5RnuZdA5bwoYTCH73QLrE");
    });
    it("can convert a p2pkh address to a hex address", async () => {
        const hexAddress = await test_1.rpc.getHexAddress("qZoV3RKeHaxKM5RnuZdA5bwoYTCH73QLrE");
