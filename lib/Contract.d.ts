...
import { IRPCCallContractResult, IRPCGetTransactionReceiptBase, IRPCGetTransactionResult, IRPCSendToContractResult, VdsRPC, IRPCWaitForLogsRequest, ILogEntry } from "./VdsRPC";
...
export declare class Contract {
     ...
     */
    constructor(rpc: VdsRPC, info: IContractInfo, opts?: IContractInitOptions);
     ...
     * @return parse data
     */
    callFunc(callMethod: string, callArgs?: any[], opts?: IContractCallRequestOptions): Promise<any>;
    /**
