import {VdsRPCRaw} from "./VdsRPCRaw"
...
export interface IRPCSendToContractRequest {
    ...
    /**
     * The amount in VDS to send. eg 0.1, default: 0
     */
    ...
    /**
     * Vds price per gas unit, default: 0.00000001, min:0.00000001
     */
...
export interface IRPCCallFuncContractRequest {
...
export class VdsRPC extends VdsRPCRaw {
    ...
    public callContractFunc(req: IRPCCallFuncContractRequest): Promise<any> {
        const args = [
            req.address,
            req.method,
            req.args,
        ...
        return this.rawCall("callcontractfunc", args)
    }
